...
{
  //local vars
  static int decPlace = 0;
  static int delay = 0;

  if(delay == 5000){
    delay = 0;
    sevseg.setNumber(decPlace / 10.0f,1);
    decPlace++;
    decPlace %= 1000; //rollover back to 0 once variable gets to 4; To anyone wondering: the % is called the "modulo" operator; see here for explanation & example: https://www.arduino.cc/en/Reference/Modulo
  }
